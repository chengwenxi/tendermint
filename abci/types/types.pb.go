...
func (m *BlockSizeParams) GetMaxGas() uint64 {
	if m != nil {
		return m.MaxGas
	}
	return 0
...
func (*EvidenceParams) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{27} }
...
func (*ValidatorParams) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{28} }
...
func (*Version) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{31} }
...
func (*ValidatorUpdate) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }
...
func (*PubKey) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{37} }
...
func (*Evidence) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{38} }
...
func (m *Evidence) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintTypes(dAtA, i, uint64(types1.SizeOfStdTime(m.Time)))
	n43, err := types1.StdTimeMarshalTo(m.Time, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n43
...
func NewPopulatedBlockSizeParams(r randyTypes, easy bool) *BlockSizeParams {
	...
	this.MaxGas = uint64(uint64(r.Uint32()))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedHeader(r randyTypes, easy bool) *Header {
	...
	v35 := types1.NewPopulatedStdTime(r, easy)
	this.Time = *v35
...
func NewPopulatedEvidence(r randyTypes, easy bool) *Evidence {
	...
	v54 := types1.NewPopulatedStdTime(r, easy)
	this.Time = *v54
...
var fileDescriptorTypes = []byte{
	...
	0xa6, 0xb1, 0xea, 0x87, 0xd6, 0x67, 0x74, 0xf1, 0x11, 0x8d, 0xad, 0x1d, 0x68, 0xe5, 0x8f, 0xa6,
	0x45, 0x35, 0x22, 0xae, 0xa2, 0xe8, 0xc1, 0x98, 0x59, 0xf7, 0xa0, 0x5d, 0x38, 0x11, 0xb1, 0xa0,
	...
	,
}
